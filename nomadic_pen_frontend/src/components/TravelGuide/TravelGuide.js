...
const TravelGuide = () => {
    ...
    useEffect(() => {
        const fetchBlogData = async () => {
            try {
                const blogDataResponse = await axios.get('http://localhost:8000/nomadic-pen/travel-guide');
        ...
        const fetchFeatureCities = async () => {
            try{
                const fetchQueryResponse = await axios.get('http://localhost:8000/nomadic-pen/travel-guide/fetch-feature-cities');
        ...
        const fetchFeatureDurations = async () => {
            try{
                const fetchQueryResponse = await axios.get('http://localhost:8000/nomadic-pen/travel-guide/fetch-feature-durations');
                const fetchResponseData = fetchQueryResponse.data;
